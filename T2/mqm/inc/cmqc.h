 ...
 /****************************************************************/
 /* <BEGIN_BUILDINFO>                                            */
 /* Generated on:  3/19/20 4:14 PM                               */
 /* Build Level:   P800-L200319-161303                           */
 ...
 #endif
 /***********************************************************************/
 /* Align 32-bit MQI data structures shared2 for ABI compatibility v5.3 */
 /***********************************************************************/
 ...
 #define MQ_CERT_VAL_POLICY_DEFAULT     1
 ...
 #define MQCNO_GUARDIAN_BINDING         0x00020000
 ...
 /****************************************************************/
 /* Values Related to MQIPC Structure   (MQGET with IPC          */
 /* completion - IPC structure)                                  */
 /****************************************************************/

 /* Structure Identifier */
 #define TRIGGER_RESPONSE               6
 ...
 /****************************************************************/
 /* MQIPC Structure (MQGET with IPC completion - IPC structure)  */
 /****************************************************************/


 typedef struct tagMQIPC MQIPC;
 typedef MQIPC  MQPOINTER PMQIPC;
 typedef PMQIPC MQPOINTER PPMQIPC;

 struct tagMQIPC {
   MQINT16  MsgCode;  /* Value TRIGGER_RESPONSE */
   MQLONG   ApplTag;  /* Signal1 field from GMO */
   MQLONG   Status;   /* MQRC_NONE, MQRC_NO_MSG_AVAILABLE, */
                      /* MQRC_CONNECTION_BROKEN, MQRC_GET_INHIBITED */
 };

 #define MQIPC_DEFAULT MQCC_OK,\
                       0,\
                       0
