...
#pragma pop warn
extern SQLMODULE_ID __SQL_mod_123456119139637670;
#line 1 "C:\\ABM\\T3\\src\\INSjob.ec"
#include<stdio.h>
#include<string.h>

  /* EXEC SQL MODULE MTEST NAMES ARE ISO88591; */
#line 5 "C:\\ABM\\T3\\src\\INSjob.ec"

  /* EXEC SQL DECLARE NAMETYPE 'ANSI'; */
#line 7 "C:\\ABM\\T3\\src\\INSjob.ec"

int main()
 {
  /* EXEC SQL BEGIN DECLARE SECTION; */
#line 11 "C:\\ABM\\T3\\src\\INSjob.ec"
   /* EXEC SQL  INVOKE SAMDBCAT.PERSNL.JOB AS jobtbl; *//* Beginning of generated code for SQL INVOKE */
struct  jobtbl{
...
#line 12 "C:\\ABM\\T3\\src\\INSjob.ec"
  int    jobcode;
  char jobdesc[18];
  char SQLSTATE[6];
  long  SQLCODE;
  /* EXEC SQL END DECLARE SECTION; */
#line 17 "C:\\ABM\\T3\\src\\INSjob.ec"
  ...
  /* EXEC SQL BEGIN WORK; */
#line 24 "C:\\ABM\\T3\\src\\INSjob.ec"
{
#line 24 "C:\\ABM\\T3\\src\\INSjob.ec"
static struct SQLCLI_OBJ_ID __SQL_id0 = {
#line 24 "C:\\ABM\\T3\\src\\INSjob.ec"
11, stmt_name, &__SQL_mod_123456119139637670, "SQLMX_DEFAULT_STATEMENT_3"
#line 24 "C:\\ABM\\T3\\src\\INSjob.ec"
,0, 0, 
#line 24 "C:\\ABM\\T3\\src\\INSjob.ec"
25, 0, 0};
...
#line 25 "C:\\ABM\\T3\\src\\INSjob.ec"
{
#line 25 "C:\\ABM\\T3\\src\\INSjob.ec"
static struct SQLCLI_OBJ_ID __SQL_id0 = {
#line 25 "C:\\ABM\\T3\\src\\INSjob.ec"
11, stmt_name, &__SQL_mod_123456119139637670, "SQLMX_DEFAULT_STATEMENT_4"
#line 25 "C:\\ABM\\T3\\src\\INSjob.ec"
,0, 0, 
#line 25 "C:\\ABM\\T3\\src\\INSjob.ec"
25, 0, 0};
...
#line 25 "C:\\ABM\\T3\\src\\INSjob.ec"
11, desc_name, &__SQL_mod_123456119139637670, 
...
#line 25 "C:\\ABM\\T3\\src\\INSjob.ec"
SQL_EXEC_GetCSQLSTATE(SQLSTATE,SQLCODE);}
#line 26 "C:\\ABM\\T3\\src\\INSjob.ec"

/* printf("\n SQLSTATE = %s ",SQLSTATE);
   printf("\n SQLCODE  = %d". SQLCODE);
*/
  /* EXEC SQL COMMIT WORK; */
#line 30 "C:\\ABM\\T3\\src\\INSjob.ec"
{
#line 30 "C:\\ABM\\T3\\src\\INSjob.ec"
static struct SQLCLI_OBJ_ID __SQL_id0 = {
#line 30 "C:\\ABM\\T3\\src\\INSjob.ec"
11, stmt_name, &__SQL_mod_123456119139637670, "SQLMX_DEFAULT_STATEMENT_5"
#line 30 "C:\\ABM\\T3\\src\\INSjob.ec"
,0, 0, 
#line 30 "C:\\ABM\\T3\\src\\INSjob.ec"
25, 0, 0};
...
}SQLMODULE_ID __SQL_mod_123456119139637670 = {
/* version */    	11,
/* filler1 */    	{0,0,0,0},
/* module name */	"SAMDBCAT.PERSNL.MTEST",
/* timestamp */  	123456119139637670,
/* char set */   	"ISO88591",
/* name len */   	21,
/* filler2 */    	{0,0,0,0},
/* handle */     	0,
...
unsigned char* 
C__ABM_T3_src_INSjob_c123456119139637670()
{
 ...
 ,96,123,124,125,126,0,21,83,65,77,68,66,67,65,84
 ,46,80,69,82,83,78,76,46,77,84,69,83,84,45,45
 ,45,32,72,101,119,108,101,116,116,32,80,97,99,107,97
 ,114,100,32,69,110,116,101,114,112,114,105,115,101,32,78
 ,111,110,83,116,111,112,40,84,77,41,32,83,81,76,47
 ,77,88,32,67,47,67,43,43,32,80,114,101,112,114,111
 ,99,101,115,115,111,114,32,51,46,57,46,49,32,103,101
 ,110,101,114,97,116,101,100,32,109,111,100,117,108,101,32
 ,100,101,102,105,110,105,116,105,111,110,32,102,105,108,101
 ,46,10,10,77,79,68,85,76,69,32,83,65,77,68,66
